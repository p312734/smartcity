...
function getdatetimestr(): string {
    let strdatetime = zeropad(RTC_DS1307.getTime(RTC_DS1307.TimeType.YEAR), 4) + "-" + zeropad(RTC_DS1307.getTime(RTC_DS1307.TimeType.MONTH), 2) + "-" + zeropad(RTC_DS1307.getTime(RTC_DS1307.TimeType.DAY), 2) + " " + zeropad(RTC_DS1307.getTime(RTC_DS1307.TimeType.HOUR), 2) + ":" + zeropad(RTC_DS1307.getTime(RTC_DS1307.TimeType.MINUTE), 2) + ":" + zeropad(RTC_DS1307.getTime(RTC_DS1307.TimeType.SECOND), 2)
    return strdatetime
}
