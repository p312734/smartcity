...
input.onButtonPressed(Button.AB, function on_button_pressed_ab() {
    ...
    RTC_DS1307.setTime(RTC_DS1307.TimeType.MINUTE, 10)
    RTC_DS1307.setTime(RTC_DS1307.TimeType.SECOND, 0)
    OLED.writeStringNewLine("Uhrzeit gesetzt: " + RTC_DS1307.getTime(RTC_DS1307.TimeType.YEAR) + "-" + RTC_DS1307.getTime(RTC_DS1307.TimeType.MONTH) + "-" + RTC_DS1307.getTime(RTC_DS1307.TimeType.DAY) + "-" + " " + RTC_DS1307.getTime(RTC_DS1307.TimeType.HOUR) + ":" + RTC_DS1307.getTime(RTC_DS1307.TimeType.MINUTE) + ":" + RTC_DS1307.getTime(RTC_DS1307.TimeType.MINUTE) + ":" + RTC_DS1307.getTime(RTC_DS1307.TimeType.SECOND))
})
